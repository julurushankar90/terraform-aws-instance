...
* instance_type - (Optional) string type, default value is t3.micro. users can overide.
* sg_ids - (Required) list of string, user must provide list of security group ids instance should have.
